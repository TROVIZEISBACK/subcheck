// Auto-ported from the Phase 1 src/data.js service catalog. Do not edit by hand;
// this is the local recognition catalog used for redundancy/overlap checks.
import type { CategoryKey, CatalogService, CategoryMeta, Preferences } from "./types";
